...
export function About() {
    return <div className="aboutPage">
        <div className="hero">
            <h1>Welcome to Kiddos – Where Imagination Comes to Play!</h1>
            <p>At Kiddos, we believe that toys are more than just playthings—they are the building blocks of creativity, discovery, and lifelong memories. Founded in 1993, our mission has always been simple: to bring joy, wonder, and high-quality play experiences to children and families everywhere.</p>
            <h2>Our Story</h2>
